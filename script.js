const tripData = [
    ...
    activities: [
      {
        ...
        address: "Corner of Wallcliffe Road and Farrelly St, Margaret River WA 6285",
        tag: "activity",
        duration: "1h 35m",
        tip: "Arrive 10-15 mins early to find comfortable parking. Mass starts at 10am.",
      },
      {
        time: "11:15",
        desc: "Early lunch at Dear Darnell's",
        address: "3 Redgate Rd, Witchcliffe WA 6286",
        tag: "activity",
        duration: "1h 30m",
        tip: "A cosy spot right in the heart of Witchcliffe before the afternoon of vintage shopping.",
      },
      {
        time: "12:45",
        desc: "Vintage shopping: Beanhead Records/LucyKat, Poolroom, The Tiny Store, The Flying Wardrobe, Lime Beach Reloved, The Witch and Windmill",
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: "10:40",
        desc: "Gabriel Chocolate, MR Chocolate Factory, Wulura Olive Oil",
...
const tripDataPart2 = [
  {
    ...
    activities: [
      ...
      {
        time: "10:00",
        desc: "Shop Cowaramup: Mukau Giftware, Candy Cow, Temper Temper Fine Chocolate",
      ...
      {
        time: "11:00",
        desc: "Wine & gin tasting at After Hours Wine and Gindong Gin",
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: "15:30",
        desc: "Guildford: Georges Furniture Restoration + Book Exchange",
        address: "179 James St, Guildford WA 6055",
        tag: "activity",
        duration: "50 mins",
        closesAt: "16:30",
        tip: "Guildford is Perth's main antique hub. Lots of convict history in these streets. Sue can grab a coffee at the Guildford Milk Bar two doors down while everyone browses.",
      },
      {
        time: "16:20",
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: "10:30",
        desc: "Explore: Mills Records, High Street Mall, The Piazza, Elizabeth's Bookshop",
      ...
      {
        time: "13:45",
        desc: "Shopping: Common Ground, Ginger Pudding Vintage, Bill Campbell Books, The Record Finder",
...
const tripDataPart3 = [
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: "17:15",
        desc: "Sue's final workout (ends 6:00pm)",
        tag: "exercise",
        duration: "45 mins",
        tip: "A good heavy session before being seated on an airplane for 5 hours tomorrow. Remember to throw away your gloves!",
      },
      {
        time: "18:45",
  ...
  },
  {
    ...
    activities: [
      ...
      {
        time: "09:15",
        desc: "Head to boarding gate",
        tag: "activity",
        duration: "40 mins",
        tip: "Last chance to spend any leftover AUD coins at the airport shops.",
      },
      {
        time: "09:55",
...
function getCoordinatesForAddress(address) {
  const coordinates = {
    ...
    "Corner of Wallcliffe Road and Farrelly St, Margaret River WA 6285": [-33.9539, 115.0764],
    ...
    "179 James St, Guildford WA 6055": [-31.9, 115.97],
